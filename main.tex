...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\includegraphics[height=.7cm]{logo-ensa-berrechid.png}}
\fancyhead[R]{\includegraphics[height=.7cm]{logo_hassan1.png}}
\fancyfoot[C]{\thepage}
...
% Page de titre utilisant le format de main (1)
\begin{titlepage}
    \pagestyle{empty}
    
    % En-tête avec logos et nom de l'université
    \begin{table}[h!]
    \centering
    \begin{tabular}{|>{\centering}p{3cm}|>{\centering}p{8cm}|>{\centering}p{3cm}|}
    \hline
    \includegraphics[width=2.5cm]{logo_hassan1.png} & 
    \textbf{Université Hassan 1\textsuperscript{er}} \\ 
    \textbf{École Nationale des Sciences Appliquées -- Berrechid} &
    \includegraphics[width=2.5cm]{logo-ensa-berrechid.png} \\
    \hline
    \end{tabular}
    \end{table}
    ...
    \includegraphics[width=5cm]{logo-Xperlik.png}
    
    \vspace{1cm}
    
    {\Large \textbf{Système de Réservation de Rendez-vous 
    clone de calendly}}
    \end{center}
    
    \vspace{2cm}
    
    % Tableau réalisé par / encadré par
    \begin{table}[h!]
    \centering
    \renewcommand{\arraystretch}{1.4} % un peu plus d'espace vertical
    ...
    \hline
    \textbf{Soutenue le 18/09/2025, devant le jury composé de:} \\
    \hline
    \vspace{0.2cm}
    - Pr. HNINI Abdelhalim\\
    \vspace{0.2cm}
...
Ce rapport présente un système de réservation de rendez-vous dérivé de google calendar Agenda développé par Experlik. La plateforme calendlyClone permet aux utilisateurs de réserver des rendez-vous avec différents prestataires de services, de gérer des événements, et d'utiliser des codes promotionnels.
...
\begin{itemize}
    ...
    \item Fournir des outils d'administration
\end{itemize}
...
\subsubsection{Payzone \textcolor{purple}{solution marocaine}}
\begin{itemize}
...
Cette plateforme apporte une solution pour :
\begin{itemize}
